...
class videoController: NSObject, NSCacheDelegate {
    ...
    static let sharedVideoPlayer = videoController()
    ...
    private func addObservers(url: String, videoContainer: VideoContainer) {
        if self.observingURLs[url] == false || self.observingURLs[url] == nil {
            videoContainer.player.currentItem?.addObserver(self,
                                                           forKeyPath: "status",
                                                           options: [.new, .initial],
                                                           context: &videoController.playerViewControllerKVOContext)
    ...
    override func observeValue(forKeyPath keyPath: String?, of object: Any?,
        ...
        guard context == &videoController.playerViewControllerKVOContext else {
